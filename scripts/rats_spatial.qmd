...
Create census block level estimates of 311 rat requests for the cities of Somerville and Cambridge, MA.
...
# Filter to only likely rat reports
# see scripts/create_full_rats_dataset.qmd for how I determined this flag
cambridge_rats_only <- cambridge_311 %>%
  filter(is_likely_rat == TRUE)

```

```{r}

# Clean GEOID and years
...
# Pull in Census block data to create a block-level map of rat reports
